...
export default class ExerciseScreen extends React.Component{
  ...
  fetchExercise(){
    ...
    this.setState({exerciseOne:this.state.exerciseDay[1]})
...
displayImages(){
  ...
  render(){
    return(
      ...
      <Text style={styles.header}> Exercise Two: </Text> 
      <Text style={styles.days}>  {exerDay[0][1]} </Text>
      {this.displayImages()}
      <TouchableOpacity style={styles.nextExer} onPress={()=>{
         this.props.navigation.navigate("Exercise3")
      }}> Next Exercise </TouchableOpacity>
      </View>
    )
  }
}
