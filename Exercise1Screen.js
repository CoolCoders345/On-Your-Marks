...
displayImages(){
  ...
  render(){
    return(
      ...
      <Text style={styles.header}> Exercise One: </Text> 
      <Text style={styles.days}>  {exerDay[0][0]} </Text>
      {this.displayImages()}
